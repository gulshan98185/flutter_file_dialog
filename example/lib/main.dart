          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (_currentFile?.existsSync() == true) ...[
                Text("${(_currentFile.lengthSync() / 1024.0).toStringAsFixed(1)} KB"),
                SizedBox(
                  width: 200,
                  height: 200,
                  child: Image.file(
  ...
  Future<void> _saveFile(bool useData) async {
    ...
    try {
      ...
      final params = SaveFileDialogParams(
          sourceFilePath: useData ? null : _currentFile.path, data: data, localOnly: _localOnly, fileName: useData ? "untitled" : null);
